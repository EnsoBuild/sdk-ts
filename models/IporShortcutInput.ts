 ...
 */
export function instanceOfIporShortcutInput(value: object): value is IporShortcutInput {
    if (!('amountIn' in value) || value['amountIn'] === undefined) return false;
    if (!('tokenIn' in value) || value['tokenIn'] === undefined) return false;
    if (!('tokenBToBuy' in value) || value['tokenBToBuy'] === undefined) return false;
    if (!('percentageForTokenB' in value) || value['percentageForTokenB'] === undefined) return false;
    return true;
}
...
export function IporShortcutInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): IporShortcutInput {
    if (json == null) {
        return json;
    }
    return {
...
export function IporShortcutInputToJSON(json: any): IporShortcutInput {
    return IporShortcutInputToJSONTyped(json, false);
}

export function IporShortcutInputToJSONTyped(value?: IporShortcutInput | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
