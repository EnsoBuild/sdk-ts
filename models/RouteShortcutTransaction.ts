 ...
 */
export function instanceOfRouteShortcutTransaction(value: object): value is RouteShortcutTransaction {
    if (!('gas' in value) || value['gas'] === undefined) return false;
    if (!('amountOut' in value) || value['amountOut'] === undefined) return false;
    if (!('priceImpact' in value) || value['priceImpact'] === undefined) return false;
...
export function RouteShortcutTransactionFromJSON(json: any): RouteShortcutTransaction {
    return RouteShortcutTransactionFromJSONTyped(json, false);
}

export function RouteShortcutTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): RouteShortcutTransaction {
    if (json == null) {
        return json;
    }
    return {
...
export function RouteShortcutTransactionToJSON(json: any): RouteShortcutTransaction {
    return RouteShortcutTransactionToJSONTyped(json, false);
}

export function RouteShortcutTransactionToJSONTyped(value?: RouteShortcutTransaction | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
