 ...
 */
export function instanceOfIporShortcutTransaction(value: object): value is IporShortcutTransaction {
    if (!('createdAt' in value) || value['createdAt'] === undefined) return false;
    if (!('tx' in value) || value['tx'] === undefined) return false;
    if (!('logs' in value) || value['logs'] === undefined) return false;
    if (!('simulationURL' in value) || value['simulationURL'] === undefined) return false;
    return true;
}

export function IporShortcutTransactionFromJSON(json: any): IporShortcutTransaction {
    return IporShortcutTransactionFromJSONTyped(json, false);
}

export function IporShortcutTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): IporShortcutTransaction {
    if (json == null) {
        return json;
    }
    return {
...
export function IporShortcutTransactionToJSON(json: any): IporShortcutTransaction {
    return IporShortcutTransactionToJSONTyped(json, false);
}

export function IporShortcutTransactionToJSONTyped(value?: IporShortcutTransaction | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
