...
export function StandardToJSON(json: any): Standard {
    return StandardToJSONTyped(json, false);
}

export function StandardToJSONTyped(value?: Standard | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
