 ...
 */
export function instanceOfWalletApproveTransaction(value: object): value is WalletApproveTransaction {
...
export function WalletApproveTransactionFromJSON(json: any): WalletApproveTransaction {
    return WalletApproveTransactionFromJSONTyped(json, false);
}

export function WalletApproveTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): WalletApproveTransaction {
    if (json == null) {
        return json;
    }
    return {
...
export function WalletApproveTransactionToJSON(json: any): WalletApproveTransaction {
    return WalletApproveTransactionToJSONTyped(json, false);
}

export function WalletApproveTransactionToJSONTyped(value?: WalletApproveTransaction | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
