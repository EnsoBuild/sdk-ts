...
export class WalletApi extends runtime.BaseAPI {
     ...
     */
    async walletControllerCreateApproveTransactionRaw(requestParameters: WalletControllerCreateApproveTransactionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WalletApproveTransaction>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => WalletApproveTransactionFromJSON(jsonValue));
    }

    /**
     * Returns transaction that approves your EnsoWallet to spend tokens
     */
    async walletControllerCreateApproveTransaction(requestParameters: WalletControllerCreateApproveTransactionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<WalletApproveTransaction> {
        const response = await this.walletControllerCreateApproveTransactionRaw(requestParameters, initOverrides);
     ...
     */
    async walletControllerWalletBalancesRaw(requestParameters: WalletControllerWalletBalancesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<WalletBalance>>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(WalletBalanceFromJSON));
    }

    /**
     * Returns all balances for a given wallet
     */
    async walletControllerWalletBalances(requestParameters: WalletControllerWalletBalancesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<WalletBalance>> {
        const response = await this.walletControllerWalletBalancesRaw(requestParameters, initOverrides);
        return await response.value();
    }
